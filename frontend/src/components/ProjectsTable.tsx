                         ...
                         <td className="md:hidden block w-full space-y-3 p-4 border-b border-gray-200">
                           ...
                           <div className="flex justify-between items-end border-t border-gray-100/50 pt-3" onClick={() => toggleExpand(p.id)}>
                             ...
                             <div className="flex flex-col text-right">
                               ...
                               <span className="text-amber-600 text-[10px] font-bold mt-1 uppercase tracking-wider">€{Number(p.total_value - (p.already_paid || 0)).toLocaleString()} To Invoice</span>
                        ...
                        {isEditing ? (
                          ...
                          >
                            ...
                            <div className="flex flex-col text-right">
                              ...
                              <span className="text-amber-600 text-[11px] font-bold mt-1.5 uppercase tracking-wider">€{Number(p.total_value - (p.already_paid || 0)).toLocaleString()} To Invoice</span>
