        ...
        <div className="p-6 md:p-8 border-b border-gray-100 bg-gradient-to-r from-white to-orange-50/30">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-black text-gray-900 tracking-tight">Expense Tracker</h2>
                <p className="text-xs text-gray-400 font-bold uppercase tracking-widest">{projectName}</p>
              </div>
            </div>
            <button onClick={onClose} className="p-2.5 hover:bg-gray-100 rounded-xl transition-all text-gray-400 hover:text-gray-900">
              <X size={22} />
            </button>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              <input
                ...
                className="flex-1 bg-white border border-gray-200 rounded-xl px-3 py-3 text-sm font-medium outline-none focus:border-[#e78b01] transition-all"
              />
              <button
                onClick={handleAdd}
